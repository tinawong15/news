import os, json, shlex, itertools
...
def search():
    ...
    if request.method == 'POST':
        ...
        tags = json.loads(request.form.get('tag_list'))
        print(tags)
        ...
        if 'entertainment' in tags:
            ...
            entertainment_paywalls = [True if source in PAYWALLS else False for source in entertainment_sources]
